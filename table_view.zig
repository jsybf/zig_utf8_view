...
pub const TableView = struct {
    ...
    pub const TableViewError = error {
        ColumnSizeMismatch, // column size of every row(including header) should be equal
    ...
    fn printStd(self: TableView) !void {
